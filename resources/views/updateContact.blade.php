        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('contact/'.$contact->id.'/update') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="contactnumber" type="text" class="form-control" name="contactnumber" value="{{ $contact->contactnumber }}" required>
                            </div>
                        </div>
