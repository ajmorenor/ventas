    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><b>Editar Servicio de las Fuentes a Empresa</b>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('servicio/update') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="fechamedicion" type="date" class="form-control" name="fechamedicion" value="{{ $servicio->fechamedicion }}" required autofocus>
                            </div>    
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="medido" name="medido" class="form-control" value="{{ $servicio->medido }}" required>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea id="observaciones" name="observaciones" rows="3" cols="40">{{ $servicio->observaciones }}</textarea>
                        </div>
